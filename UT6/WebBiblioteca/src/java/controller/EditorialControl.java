...
public class EditorialControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        if(EditorialDao.registrarEditorial(ed))request.setAttribute("mensaje", "La editorial fue registrada");
        else request.setAttribute("mensaje", "La editorial NO fue registrada");
