<%-- 
    ...
    Created on : 19-ene-2025, 21:59:18
    Author     : Danim2205
--%>
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div>
                                            <form action="LibroControl" method="post" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no padding-right">Título:</label>
                                                    <div class="col-sm-9">
                                                        <input type="text" name="titulo" value="" placeholder="Título"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no padding-right">Autor:</label>
                                                    <div class="col-sm-9">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="text" name="fecha" value="" placeholder="2025-19-01"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no padding-right">Editorial:</label>
                                                    <div class="col-sm-9">
                                                        <select name="editorial">
                                                            <option value="0">Seleccione una editorial</option>
                                                            <% for (Editorial e : EditorialDao.listarEditoriales()) {%>
