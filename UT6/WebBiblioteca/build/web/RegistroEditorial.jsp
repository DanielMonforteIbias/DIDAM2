<%-- 
    ...
    Created on : 19-ene-2025, 21:16:02
    Author     : Danim2205
--%>
										...
										<div>
                                                                                    <form action="EditorialControl" method="post" class="form-horizontal">
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no padding-right">Nit:</label>
                                                                                            <div class="col-sm-9">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no padding-right">Sitio web:</label>
                                                                                            <div class="col-sm-9">
