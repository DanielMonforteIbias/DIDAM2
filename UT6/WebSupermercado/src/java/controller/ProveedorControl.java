...
public class ProveedorControl extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
        ...
        if(ProveedorDao.registrarProveedor(prov))request.setAttribute("mensaje", "El proveedor fue registrada");
        else request.setAttribute("mensaje", "El proveedor NO fue registrada");
