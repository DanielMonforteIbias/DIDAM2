                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <div>
                                            <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    <%for (Producto prod : ProductoDao.listarProductos()) {%>
                                                    <tr>
                                                        <td>
                                                            <a href="#"><%=prod.getCodigo()%></a>
                                                        </td>
                                                        <td class="hidden-480"><%=prod.getNombre()%></td>
                                                        <td><%=prod.getCantidad()%></td>
                                                        <td><%=prod.getPrecio()%></td>
                                                        <td>
                                                            <span class="label label-sm label-success"><%=CategoriaDao.getCategoria(prod.getCodigoCategoria())%></span>
                                                        </td>
                                                        <td><span class="label label-sm label-success"><%=ProveedorDao.getProveedor(prod.getNitProveedor())%></span></td>
                                                        <td>
