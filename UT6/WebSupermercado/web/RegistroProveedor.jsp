<%-- 
    ...
    Created on : 19-ene-2025, 21:41:36
    Author     : Danim2205
--%>
										...
										<div>
                                                                                    <form action="ProveedorControl" method="post" class="form-horizontal">
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-1 control-label no padding-right">Nit:</label>
                                                                                            <div class="col-sm-9">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-1 control-label no padding-right">Telefono:</label>
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="telefono" value="" placeholder="Telefono"/>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-1 control-label no padding-right">Dirección:</label>
                                                                                            <div class="col-sm-9">
