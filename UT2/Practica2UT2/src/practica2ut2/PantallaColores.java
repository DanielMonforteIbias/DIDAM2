 ...
 * @author Tarde
 */
public class PantallaColores extends javax.swing.JDialog {

    /**
     * Creates new form PantallaColores
     */
    public PantallaColores(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        botonColores.setFont(new java.awt.Font("Microsoft YaHei", 1, 14)); // NOI18N
    ...
    private void botonColoresActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonColoresActionPerformed
        setVisible(false);
        PantallaAzul azul=new PantallaAzul(new Frame(),true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PantallaColores dialog = new PantallaColores(new javax.swing.JFrame(), true);
