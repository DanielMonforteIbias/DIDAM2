 ...
 * @author Tarde
 */
public class PantallaAzul extends javax.swing.JDialog {

    /**
     * Creates new form PantallaAzul
     */
    public PantallaAzul(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        botonAzul.setFont(new java.awt.Font("Microsoft YaHei", 1, 14)); // NOI18N
    ...
    private void botonAzulActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAzulActionPerformed
        setVisible(false);
        PantallaZafiro zafiro=new PantallaZafiro(new Frame(),true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PantallaAzul dialog = new PantallaAzul(new javax.swing.JFrame(), true);
